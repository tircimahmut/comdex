...
SOVEREIGN_BINARY="comdex-sd"
CONSUMER_BINARY="comdex-icdd"
NODE_IP="localhost"
...
sleep 5
$SOVEREIGN_BINARY tx bank send $SOVEREIGN_VALIDATOR comdex1qwhddffw7ljzmgn9cxcd76t40aq0e65psdvryh 1000000stake --keyring-backend=test --chain-id=$CONSUMER_CHAIN_ID -y --broadcast-mode=sync --node=http://$SOVEREIGN_RPC_LADDR --home=$SOVEREIGN_HOME
sleep 5
...
# $SOVEREIGN_BINARY tx gov submit-legacy-proposal software-upgrade "v15" --upgrade-height=36  \
...
$SOVEREIGN_BINARY tx gov submit-legacy-proposal software-upgrade "v15" \
--upgrade-height=36 \
--upgrade-info="file:///Users/admin/Documents/j121/comdex/interchain-security/upgrade-info.json?checksum=sha256:66a0bd2ce260927747e2f26522b937d773d13b79c7e5b07e2f5efa483d6fabe0" \
--title="upgrade to consumer chain" --description="upgrade to consumer chain description" \
...
# --upgrade-height=36 \
# --upgrade-info="file:///Users/admin/Documents/j121/comdex/interchain-security/upgrade-info1.json?checksum=sha256:3f0309a1179afb7d7eb9090a13ce9fdca0ce46b39ac6908b415d901b822f046a" \
# --title="upgrade to consumer chain" --description="upgrade to consumer chain description" \
# --from=$SOVEREIGN_VALIDATOR $KEYRING --chain-id=$CONSUMER_CHAIN_ID --home=$SOVEREIGN_HOME --yes -b sync --deposit="100000000stake"
