...
// that allow comdex chain to be started locally without having to start the provider chain and the relayer.
...
func CreateMinimalConsumerTestGenesis() *ccvtypes.ConsumerGenesisState {
	...
	genesisState.Provider.ClientState.ChainId = "comdex"
